...
/**
 * swap_ints - funct that swap two integers in an array.
...
/**
 * sort_array - Implement the quicksort algorithm through recursion.
...
void sort_array(int *array, size_t size, int left, int right)
{
	...
	if (right - left > 0)
	{
		part = lomuto_partitn(array, size, left, right);
